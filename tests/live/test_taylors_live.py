...
from house_scrapers.scrapers.taylors import detail_offer, http_session, scrape_all, scrape_new_today

pytestmark = pytest.mark.live

@pytest.mark.skipif(os.getenv("RUN_LIVE_SCRAPERS") != "1", reason="set RUN_LIVE_SCRAPERS=1")
def test_taylors_json_modes_and_detail_contract():
    ...
    with http_session() as session:
        ...
        assert offer["metadata"]["source"] == "taylors"
